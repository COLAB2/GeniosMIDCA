...
#     STATE_FILE = "C:/Users/Zohreh/git/MIDCA/modules/_plan/jShop/problem"
    f = open(STATE_FILE, 'w')
    f.write('\n')
    f.write("(defproblem problem franklin-mission ((loc)\n")
    f.write("\n")
    ...
    for atom in world.atoms:
        ...
        if atom.predicate.name == "achieved_mission":
            f.write("(achievedMission " + atom.args[0].name + " " +  atom.args[1].name + ")\n")
        elif atom.predicate.name == "enabled":
            f.write("(enabled " + atom.args[0].name + " )\n")

        elif atom.predicate.name == "at_location":
            f.write("(atLocation " + atom.args[0].name + " )\n")
...
#     STATE_FILE = "C:/Users/Zohreh/git/MIDCA/modules/_plan/jShop/problem"
    ...
    for goal in goals:
        ...
        if args[0] == predicate:
            args.pop(0)
        if predicate == "achieved_mission":
            f.write("(achievedMission " +  args[0] + " " +  args[1] + ")\n")
